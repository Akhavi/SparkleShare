...
namespace SparkleShare {
    ...
    public class SparklePlugin {
        ...
        public static SparklePlugin Create (string name, string description,
            string address_value, string address_example,
            string path_value, string path_example)
        {
            string plugin_path = System.IO.Path.Combine (LocalPluginsPath, name + ".xml");
            Console.WriteLine ("111111111111");
            //if (File.Exists (plugin_path))
              //  return null;
            Console.WriteLine ("1111122222222222222221111111");
